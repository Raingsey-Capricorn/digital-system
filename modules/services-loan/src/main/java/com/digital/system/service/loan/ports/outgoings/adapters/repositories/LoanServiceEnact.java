package com.digital.system.service.loan.ports.outgoings.adapters.repositories;
...
import com.digital.system.service.loan.infrastructure.http.WebClientCommunicator;
import com.digital.system.service.loan.ports.outgoings.LoanService;
...
public class LoanServiceEnact implements LoanService {
    ...
    /**
     * This is to be used as load-balancer as well, as the first URL is down,
     * the next temporary is supposed to be up and serve
     *
